        ...
        <div>
                ...
                <div id="carouselExampleSlidesOnly" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner">
                        <div class="carousel-item active">
                            <img src={"https://m.media-amazon.com/images/I/51lo3-yD8uL._SX3000_.jpg"} className="d-block w-100" alt="First slide" style={{ height: "auto" }} />
                        </div>
                        <div className="carousel-item">
                            <img src={"https://m.media-amazon.com/images/I/61diM23XlcL._SX3000_.jpg"} className="d-block w-100" alt="Second slide" style={{ height: "auto" }} />
                        </div>
                        <div className="carousel-item">
                            <img src={"https://m.media-amazon.com/images/I/71QuUk6VrwL._SX3000_.jpg"} className="d-block w-100" alt="Third slide" style={{ height: "auto" }} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="" id="Products">
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 col-md-12">
                            <h3 className="text-center mt-4 text-secondary">Favourite Products</h3>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-sm-4 mb-5">
                            <div className="card mt-4">
                                <img src={"https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_.jpg"} className="card-img-top" alt="" />
                                <div className="card-body">
                        ...
                        <div className="col-sm-4 mb-5">
                            <div className="card mt-4">
                                <img src={"https://fakestoreapi.com/img/71kWymZ+c+L._AC_SX679_.jpg"} className="card-img-top" alt="" />
                                <div className="card-body">
                                    <h4 className="card-title text-secondary">Electronic Items</h4>
                                    <p className="card-text text-secondary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque sequi doloribus.</p>
                                </div>
                                <div className="card-footer">
                                    <a href="#" className="btn btn-primary">Find Out More!</a>
            ...
            <div class="accordion" id="accordionExample">
                <div className="container">
                    <div className="col-sm-12 col-md-12 mb-4">
                        <div className="col-sm-12 col-md-12 mb-4">
                            <h3 className="text-center text-secondary mt-4">Items and Description</h3>
                        </div>
